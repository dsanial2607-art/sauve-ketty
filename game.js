...
var settings={voice:80,sfx:70,music:45};
...
function openSettings(){
 ...
 byId('voiceStatus').innerHTML=(lang==='fr'?'Voix navigateur disponible : ':'Browser voice available: ')+(ok?'OUI / YES':'NON / NO');
